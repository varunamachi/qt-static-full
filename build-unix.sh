...
echo "Qt Install Prefix: $LINUX_QT5_INSTALL_PREFIX"
echo "Travis build dir: $TRAVIS_BUILD_DIR"
echo "Travos OS name: $TRAVIS_OS_NAME"

../qt5/qtbase/configure -opensource -confirm-license -prefix "$LINUX_QT5_INSTALL_PREFIX" -static -release -ltcg -optimize-size -no-pch -sql-sqlite -qt-zlib -qt-libjpeg -qt-libpng -qt-pcre -qt-harfbuzz -skip webengine -nomake tools -nomake tests -nomake examples
