...
../qt5/qtbase/configure -release -static -static-runtime -no-pch -opengl desktop -platform win32-g++ -prefix "$WINDOWS_QT5_INSTALL_PREFIX" -silent -sql-sqlite -qt-zlib -qt-libjpeg -qt-libpng -qt-pcre -qt-harfbuzz -skip webengine -nomake tools -nomake tests -nomake examples || exit 101
